...
// идея внутреннего хэширования совершенно прозрачна: для рзмещения конфликтующих ключей используется не вспомогательные списки, а свободные ячейки хэш-таблицы
